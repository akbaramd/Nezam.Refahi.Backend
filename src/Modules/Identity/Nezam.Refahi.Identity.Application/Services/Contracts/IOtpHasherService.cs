...
public interface IOtpHasherService
{
  ...
  Task<string> HashAsync( string phoneNumber, string otpCode, string nonce);
  ...
  Task<bool> VerifyAsync( string phoneNumber, string otpCode, string nonce, string expectedHash);
