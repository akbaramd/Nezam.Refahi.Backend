...
public class GetUserWalletBalanceQueryHandler : IRequestHandler<GetUserWalletBalanceQuery, ApplicationResult<WalletBalanceResponse>>
{
    ...
    private readonly IValidator<GetUserWalletBalanceQuery> _validator;
    private readonly WalletDomainService _walletDomainService;
    private readonly IFinanceUnitOfWork _unitOfWork;

    public GetUserWalletBalanceQueryHandler(
        IWalletRepository walletRepository,
        IWalletTransactionRepository walletTransactionRepository,
        IValidator<GetUserWalletBalanceQuery> validator,
    ...
    public async Task<ApplicationResult<WalletBalanceResponse>> Handle(
        GetUserWalletBalanceQuery request,
