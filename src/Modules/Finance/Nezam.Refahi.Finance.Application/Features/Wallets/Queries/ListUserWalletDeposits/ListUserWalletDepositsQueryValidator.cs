...
/// <summary>
/// Validator for ListUserWalletDepositsQuery
/// </summary>
public class ListUserWalletDepositsQueryValidator : AbstractValidator<ListUserWalletDepositsQuery>
{
    public ListUserWalletDepositsQueryValidator()
    {
