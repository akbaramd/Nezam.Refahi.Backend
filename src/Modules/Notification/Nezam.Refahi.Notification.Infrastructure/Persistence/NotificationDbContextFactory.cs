...
/// <summary>
/// Design-time factory for NotificationDbContext to enable EF Core tools (migrations, etc.)
/// </summary>
public class NotificationDbContextFactory : IDesignTimeDbContextFactory<NotificationDbContext>
{
    public NotificationDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseSqlServer(
            connectionString,
            x => x.MigrationsHistoryTable("__EFMigrationsHistory__Notification", "notification"));
