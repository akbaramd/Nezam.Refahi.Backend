            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.Participant", b =>
                {
                    ...
                    b.HasIndex("ReservationId", "NationalNumber")
                        .IsUnique()
                        .HasDatabaseName("IX_Participants_ReservationId_NationalNumber");
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.Tour", b =>
                {
                    ...
                    b.Property<int>("CurrentRegisteredCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.HasIndex("RegistrationStart", "RegistrationEnd");
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.TourReservation", b =>
                {
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_TourReservations_Status");

                    b.HasIndex("TourId")
                        .HasDatabaseName("IX_TourReservations_TourId");

                    b.HasIndex("TrackingCode")
                        .IsUnique()
                        .HasDatabaseName("IX_TourReservations_TrackingCode");

                    b.ToTable("TourReservations", "recreation");
                });
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.Participant", b =>
                {
                    ...
                    b.OwnsOne("Nezam.Refahi.Recreation.Domain.ValueObjects.Money", "PaidAmount", b1 =>
                        {
                    ...
                    b.OwnsOne("Nezam.Refahi.Recreation.Domain.ValueObjects.Money", "RequiredAmount", b1 =>
                        {
                            b1.Property<Guid>("ParticipantId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.TourPricing", b =>
                {
                    ...
                    b.OwnsOne("Nezam.Refahi.Recreation.Domain.ValueObjects.Money", "Price", b1 =>
                        {
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.TourReservation", b =>
                {
                    ...
                    b.OwnsOne("Nezam.Refahi.Recreation.Domain.ValueObjects.Money", "TotalAmount", b1 =>
                        {
