...
namespace Nezam.Refahi.Recreation.Infrastructure.Migrations
{
    ...
    [Migration("20250920045710_UpdateTourCapacities")]
    partial class UpdateTourCapacities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.TourCapacity", b =>
                {
                    ...
                    b.HasIndex("TourId", "IsActive");

                    b.ToTable("TourCapacities", "recreation");
                });
            ...
            modelBuilder.Entity("Nezam.Refahi.Recreation.Domain.Entities.TourReservation", b =>
                {
                    ...
                    b.HasIndex("CapacityId")
                        .HasDatabaseName("IX_TourReservations_CapacityId");
                    ...
                    b.HasIndex("MemberId")
                        .HasDatabaseName("IX_TourReservations_MemberId");
