...
/// </summary>
public class BillCreatedForReservationConsumer : INotificationHandler<BillCreatedForReservationIntegrationEvent>
{
    ...
    {
        _logger.LogInformation("Processing bill created event for reservation {ReservationId}, bill {BillId}", 
            notification.ReservationId, notification.BillId);
        ...
        {
            _logger.LogError(ex, "Error processing bill created event for reservation {ReservationId}, bill {BillId}", 
                notification.ReservationId, notification.BillId);
            throw;
        }
    }
