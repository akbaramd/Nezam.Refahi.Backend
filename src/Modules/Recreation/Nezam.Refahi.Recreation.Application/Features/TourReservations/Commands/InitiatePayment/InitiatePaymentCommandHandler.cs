...
public class InitiatePaymentCommandHandler : IRequestHandler<InitiatePaymentCommand, ApplicationResult<InitiatePaymentResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var pricing = await _pricingRepository.GetByTourIdAsync(tour.Id);
        ...
        var createBillCommand = new CreateBillCommand
        {
            ...
            ReferenceId = reservation.TrackingCode,
        ...
        {
            return ApplicationResult<InitiatePaymentResponse>.Failure(
                $"خطا در به‌روزرسانی رزرو: {ex.Message}");
        }
    }
