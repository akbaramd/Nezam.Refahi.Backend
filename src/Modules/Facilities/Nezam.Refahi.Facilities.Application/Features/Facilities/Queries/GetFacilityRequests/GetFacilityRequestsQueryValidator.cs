...
/// <summary>
/// Validator for GetFacilityRequestsQuery
/// </summary>
public class GetFacilityRequestsQueryValidator : AbstractValidator<GetFacilityRequestsQuery>
{
    ...
    private static bool HaveValidDateRange(GetFacilityRequestsQuery query)
    {
        if (!query.DateFrom.HasValue || !query.DateTo.HasValue)
            return true;

        return query.DateFrom.Value <= query.DateTo.Value;
    }
}
