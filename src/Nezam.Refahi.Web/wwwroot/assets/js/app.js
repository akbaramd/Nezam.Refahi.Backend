...
(function () {
	...
	var default_lang = "fa"; // set Default Language
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="/assets/images/logo22.png" alt="" height="22"></a>';
					...
					if (elem.querySelectorAll(".notification-item").length > 0) {
						...
						if (!emptyNotificationElem) {
							...
							<div class="text-center pb-5 mt-2">\
								<h6 class="fs-18 fw-semibold lh-base">هی! شما اعلانی برای نمایش ندارید </h6>\
							</div>\
						</div>'
						}
					}
