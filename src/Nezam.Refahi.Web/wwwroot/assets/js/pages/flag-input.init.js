...
(function () {
    ...
    function loadCountryListData(datas) {
        ...
        for (let index = 0; index < arr.length; index++) {
            ...
            <div class="flex-shrink-0 me-2"><img src="'+ arr[index]['flagImg'] + '" alt="country flag" class="options-flagimg" height="50"></div>\
            ...
            searchInput.addEventListener("keyup", function () {
                ...
                setTimeout(function () {
                    ...
                    Array.from(filterData).forEach(function (listData) {
                        ...
                        <div class="flex-shrink-0 me-2"><img src="'+ listData.flagImg + '" alt="country flag" class="options-flagimg" height="50"></div>\
                        <div class="flex-grow-1">\
