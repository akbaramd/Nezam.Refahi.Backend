...
public class LocationReferenceTests
{
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void LocationReference_Creation_With_Invalid_ProvinceName_Throws_Exception(string provinceName)
    {
        // Arrange
        Guid cityId = Guid.NewGuid();
        Guid provinceId = Guid.NewGuid();
    ...
    {
        // Arrange
        var location1 = new LocationReference(Guid.NewGuid(), Guid.NewGuid(), "Tehran", "Tehran Province");
        var location2 = new LocationReference(Guid.NewGuid(), Guid.NewGuid(), "Tehran", "Tehran Province");
